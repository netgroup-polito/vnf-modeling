...
public class PolitoDoubleFwTest {
	...
	public	PolitoDoubleFwTest(Context ctx){
	    ...
	    fw1 = new Firewall(ctx, new Object[]{nctx.nm.get("fw1"), net, nctx});
	    fw2 = new Firewall(ctx, new Object[]{nctx.nm.get("fw2"), net, nctx});
	    ...
	    fw1.Firewall_install();
	    fw2.Firewall_install();
	    ArrayList<Tuple<DatatypeExpr, DatatypeExpr>> list1 = new ArrayList<Tuple<DatatypeExpr,DatatypeExpr>>();
	    list1.add(new Tuple<DatatypeExpr, DatatypeExpr>(nctx.am.get("ip_a"),nctx.am.get("ip_c")));
	    fw1.addAcl_list(list1);
	    ArrayList<Tuple<DatatypeExpr, DatatypeExpr>> list2 = new ArrayList<Tuple<DatatypeExpr,DatatypeExpr>>();
	    list1.add(new Tuple<DatatypeExpr, DatatypeExpr>(nctx.am.get("ip_b"),nctx.am.get("ip_c")));
	    fw2.addAcl_list(list2);
	    a.EndHost_install();
	    b.EndHost_install();
	    c.EndHost_install();
