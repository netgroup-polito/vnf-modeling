...
import tests.examples.PolitoMyTest;

public class Polito_MyTest {
...
Context ctx;
    ...
    {
    	Polito_MyTest p = new  Polito_MyTest();
    	
			p.resetZ3();
			PolitoMyTest model = new PolitoMyTest(p.ctx);
		     
			IsolationResult ret =model.check.checkIsolationProperty(model.hostA,model.server );
