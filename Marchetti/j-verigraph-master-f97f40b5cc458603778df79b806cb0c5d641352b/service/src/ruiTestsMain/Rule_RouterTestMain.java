...
import ruiTests.Rule_RouterTest;


public class Rule_RouterTestMain {
...
Context ctx;
    ...
    {
    	Rule_RouterTestMain p = new Rule_RouterTestMain();
    	IsolationResult ret;
    	
    	p.resetZ3(); 	
    	Rule_RouterTest model = new Rule_RouterTest(p.ctx);
