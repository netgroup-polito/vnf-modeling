...
import ruiTests.Rule_CDNnetworkTest;
import ruiTests.Rule_HostCacheServerTest;


public class Rule_HostCacheServerTestMain {
...
Context ctx;
    ...
    public static void main(String[] args) throws Z3Exception
    {
    	...
    	p.resetZ3(); 	
    	Rule_HostCacheServerTest model = new Rule_HostCacheServerTest(p.ctx);
