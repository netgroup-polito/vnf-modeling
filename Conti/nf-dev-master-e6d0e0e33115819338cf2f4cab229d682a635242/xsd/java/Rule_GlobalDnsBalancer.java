...
public class Rule_GlobalDnsBalancer extends NetworkObject {
  ...
  @Override protected void init(  Context ctx,  Object[]... args){
    ...
    matchEntry=ctx.mkFuncDecl(n_GlobalDnsBalancer + "_matchEntry",new Sort[]{nctx.address,nctx.address},ctx.mkBoolSort());
  ...
  @Override protected void addConstraints(  Solver solver){
    ...
    Expr e_1=ctx.mkConst(n_GlobalDnsBalancer + "_entry_e_1",nctx.address);
  ...
  public void installGlobalDnsBalancer(  Expr DNS_RESPONSE,  Expr value_0){
