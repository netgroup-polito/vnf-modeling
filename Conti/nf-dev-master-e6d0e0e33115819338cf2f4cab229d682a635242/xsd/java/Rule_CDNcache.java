...
public class Rule_CDNcache extends NetworkObject {
  ...
  public void installCDNcache(  Expr webServer_Ip,  Expr client_Ip){
    ...
    constraints.add(ctx.mkForall(new Expr[]{t_0,p_0,n_0},ctx.mkImplies(ctx.mkAnd((BoolExpr)nctx.send.apply(n_CDNcache,n_0,p_0,t_0),ctx.mkNot((BoolExpr)isInternal.apply(nctx.pf.get("dest").apply(p_0)))),ctx.mkExists(new Expr[]{t_1,p_1,n_1},ctx.mkAnd((BoolExpr)nctx.recv.apply(n_1,n_CDNcache,p_1,t_1),ctx.mkLt(t_1,t_0),(BoolExpr)isInternal.apply(nctx.pf.get("src").apply(p_1)),ctx.mkEq(nctx.pf.get("proto").apply(p_1),ctx.mkInt(nctx.HTTP_REQUEST)),ctx.mkNot(ctx.mkExists(new Expr[]{t_2,p_2,n_2},ctx.mkAnd((BoolExpr)nctx.recv.apply(n_2,n_CDNcache,p_2,t_2),ctx.mkLt(t_2,t_1),ctx.mkNot((BoolExpr)isInternal.apply(nctx.pf.get("src").apply(p_2))),ctx.mkEq(nctx.pf.get("application_data").apply(p_1),nctx.pf.get("application_data").apply(p_2))),1,null,null,null,null)),ctx.mkExists(new Expr[]{t_3,p_3,n_3},ctx.mkAnd((BoolExpr)nctx.recv.apply(n_3,n_CDNcache,p_3,t_3),ctx.mkLt(t_3,t_2),ctx.mkNot((BoolExpr)isInternal.apply(nctx.pf.get("src").apply(p_2))),ctx.mkEq(nctx.pf.get("application_data").apply(p_1),nctx.pf.get("application_data").apply(p_3))),1,null,null,null,null),ctx.mkEq(nctx.pf.get("dest").apply(p_0),webServer_Ip),ctx.mkEq(nctx.pf.get("src").apply(p_0),nctx.pf.get("dest").apply(p_1)),ctx.mkEq(nctx.pf.get("src_port").apply(p_0),nctx.pf.get("src_port").apply(p_1)),ctx.mkEq(nctx.pf.get("dst_port").apply(p_0),nctx.pf.get("dst_port").apply(p_1)),ctx.mkEq(nctx.pf.get("transport_protocol").apply(p_0),nctx.pf.get("transport_protocol").apply(p_1)),ctx.mkEq(nctx.pf.get("proto").apply(p_0),nctx.pf.get("proto").apply(p_1)),ctx.mkEq(nctx.pf.get("application_data").apply(p_0),nctx.pf.get("application_data").apply(p_1))),1,null,null,null,null)),1,null,null,null,null));
